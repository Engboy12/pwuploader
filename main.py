...
AUTH_USER = os.environ.get('AUTH_USERS', '1226915008,7068000043,7341059064,5419964627,8144269730,6440249117,614886582,5817712634,7615363859,1511257208,5486913681,761536385,7080838404,1526362848,7391000887,7813618750,6148865829,7976241733').split(',')
AUTH_USERS = [int(user_id) for user_id in AUTH_USER]
if int(OWNER) not in AUTH_USERS:
    AUTH_USERS.append(int(OWNER))
CHANNEL_OWNERS = {7080838404}
